...
app.get("/student/profile",Auth,role("student"),async (req,res)=>{
    ...
    res.render("auth/student-profile",{Name:name,Email:email,about:about,college:college,degree:degree,graduationYear:graduationYear,location:location,phone:phone,skills:skills,rate:completionRate,filename:resume ? resume.fileName:" "});
